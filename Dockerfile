...
RUN apk add --no-cache bash bc coreutils jpeg-dev zlib-dev freetype-dev lcms2-dev openjpeg-dev tiff-dev tk-dev tcl-dev harfbuzz-dev fribidi-dev pngquant && \
